...
const Footer = () => {
  let displayedQuote =
    data.QuoteLines[Math.floor(Math.random() * data.QuoteLines.length)]
        ...
        <ContainerLayout>
          <FooterBody>
            ...
            <div>
              <p className="text-primary quote">
                Do you want to get in touch? Drop me a note.
              </p>
          ...
          <div className="box">
            ...
            <QuoteLineSmall>
              ...
              {displayedQuote.Source != null
                ? " in " + displayedQuote.Source
                : ""}
            </QuoteLineSmall>
            ...
            <CopyRight className="text-dark">
              ...
              (c) {new Date().getFullYear()} {data.SiteAuthor} -{" "}
              <a href={data.ViewSourceUrl}> view source</a>{" "}
            </CopyRight>
          </div>
        </ContainerLayout>
      </FooterStyle>
